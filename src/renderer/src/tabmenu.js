...
document.getElementById('motionControlApply').addEventListener('click', function () {
  motionControl = [
    document.getElementById('motion_sensitivity_slider').value,
    document.getElementById('motion_smoothing_slider').value,
    document.getElementById('lateral_only_mode').checked,
...
document.getElementById('outputApplySettings').addEventListener('click', function () {
  outputSettings = [
    document.getElementById('servoMinAngle').value,
    document.getElementById('servoMaxAngle').value
  ]
...
document.getElementById('motionControlButton').addEventListener('click', function () {
  clearTabContent()
  removeFocus()
